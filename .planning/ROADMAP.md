...
- [ ] **Phase 1: Auth Foundation** - Provider registry, auth domain types, and OAuth token model ported from forgecode
...
- [ ] 01-02-PLAN.md — Provider registry (Anthropic, OpenAI, Claude Code, Codex) in codiv-common
