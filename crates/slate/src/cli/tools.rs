...
pub fn handle(cmd: Commands) {
    match cmd {
        Commands::Read(args) => {
            if args.agent_guide {
                println!("{}", slate_tools::agent_guide::agent_guide("read"));
                return;
            }
            ...
            output_result(slate_tools::tools::read::execute(value), args.json_out);
        }
        Commands::Write(args) => {
            if args.agent_guide {
                println!("{}", slate_tools::agent_guide::agent_guide("write"));
                return;
            }
            let value = if args.json_in {
                read_json_stdin()
            ...
            output_result(slate_tools::tools::write::execute(value), args.json_out);
        }
        Commands::Edit(args) => {
            if args.agent_guide {
                println!("{}", slate_tools::agent_guide::agent_guide("edit"));
                return;
            }
            let value = if args.json_in {
                read_json_stdin()
            ...
            output_result(slate_tools::tools::edit::execute(value), args.json_out);
        }
        Commands::Glob(args) => {
            if args.agent_guide {
                println!("{}", slate_tools::agent_guide::agent_guide("glob"));
                return;
            }
            let value = if args.json_in {
                read_json_stdin()
            ...
            output_result(
                slate_tools::tools::glob::execute(value, &cwd()),
                args.json_out,
            );
        }
        Commands::Grep(args) => {
            if args.agent_guide {
                println!("{}", slate_tools::agent_guide::agent_guide("grep"));
                return;
            }
            let value = if args.json_in {
                read_json_stdin()
            ...
            output_result(
                slate_tools::tools::grep::execute(value, &cwd()),
                args.json_out,
            );
        }
        Commands::Bash(args) => {
            if args.agent_guide {
                println!("{}", slate_tools::agent_guide::agent_guide("bash"));
                return;
            }
            let value = if args.json_in {
                read_json_stdin()
            ...
            output_result(
                slate_tools::tools::bash::execute(value, &cwd(), &[]),
                args.json_out,
            );
        }
    }
