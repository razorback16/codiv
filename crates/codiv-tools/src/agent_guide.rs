...
pub fn agent_guide(tool_name: &str) -> &'static str {
    match tool_name {
        ...
        "edit" => "Find-and-replace in files. The old_string must appear exactly once unless replace_all is true. Include enough surrounding context in old_string to ensure uniqueness. Use replace_all for renaming variables or strings across a file. Prefer over write for targeted changes.",
