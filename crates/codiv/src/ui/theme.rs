...
pub struct Theme {
    ...
    pub status_thinking_on: Color,
    pub status_thinking_off: Color,
    pub status_perm_auto: Color,
    pub status_perm_manual: Color,
    pub status_perm_bypass: Color,
...
impl Theme {
    ...
    pub fn dark(depth: ColorDepth) -> Theme {
        Theme {
            ...
            status_thinking_on: Color::Yellow,
            status_thinking_off: Color::DarkGray,
            status_perm_auto: Color::Green,
            status_perm_manual: Color::Yellow,
            status_perm_bypass: Color::Red,
    ...
    pub fn light(depth: ColorDepth) -> Theme {
        Theme {
            ...
            status_thinking_on: Color::Yellow,
            status_thinking_off: Color::Gray,
            status_perm_auto: Color::Green,
            status_perm_manual: Color::Yellow,
            status_perm_bypass: Color::Red,
            ansi_tool_pending: "\x1b[1m\x1b[33m",
