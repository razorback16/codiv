...
enum InitState {
    ...
    /// Defining the __codiv_complete helper function (step 2 of 2).
    DefiningHelper {
        sentinel: String,
        accumulated: String,
    },
...
const HELPER_VERIFY_CMD: &str = "type __codiv_complete >/dev/null 2>&1";
...
impl CompletionEngine {
    ...
    pub fn complete(
        ...
        let cmd = format!("__codiv_complete {} {}", quoted_line, cursor);
